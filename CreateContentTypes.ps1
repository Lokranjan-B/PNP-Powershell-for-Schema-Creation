...
#Get the Content Type if it already exists

$contentTypeExists=Get-PnPContentType -Identity $contentType.Name 

#Check if ContentType Already Exits
...
#Create if ContentType doesn't already Exits
...
#Get the Parent Content Type Described in XML
